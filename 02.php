        ...
        <div class="container">
            ...
            //funk loomine
                ...
                function headmotted(){
                    ...
                    $siht = array("autot", "ilma","kõrvakiilu");
                    echo $alus[array_rand($alus)]." ".$oeldis[array_rand($oeldis)]." ".$siht[array_rand($siht)]."<br>";
                }
            ...
            <?php
                $nimed = array("Mari", "Kati", "Mai", "Kai", "Juuli", "Kuuli", "Maali", "Paali");
                sort($nimed);
                //print_r($nimed);
